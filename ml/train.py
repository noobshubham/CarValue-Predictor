...
DATA_PATH = "car-price-api/data/cardekho_data.csv"  # put the csv in project root (same as train.py)
MODEL_PATH = "car-price-api/artifacts/random_forest_model.pkl"
COLS_PATH = "car-price-api/artifacts/feature_columns.pkl"
